<template>
  <div>
            ...
            <div class="field is-horizontal">
              <div class="field-body">
                <div class="field">
                  ...
                  <div class="control">
                    <input @change="calcPreview" class="input" v-model="preview.route" type="number" placeholder="Distancia" autofocus required>
                  </div>
                </div>
                <div class="field">
                  <label class="label">Peso de la carga</label>
                  <div class="control">
                    <input @change="calcPreview" class="input" type="number" v-model="preview.cargo" placeholder="Carga" required>
                  </div>
                </div>
              </div>
              <div class="field-body">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="number" v-model="preview.total" placeholder="Carga" readonly>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="columns actions navbar is-fixed-bottom is-vcentered has-text-centered">
